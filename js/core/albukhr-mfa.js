(function (window, document) {
     ...
     * Dependency order:
     *
     * 1. albukhr-environment.js
     * 2. Supabase JS SDK
     * 3. supabase-core.js
     * 4. albukhr-supabase-admin-auth.js
     * 5. albukhr-mfa.js
     *
     * SECURITY AUTHORITY:
     * Supabase Auth MFA + AAL + ALBUKHR Admin Auth RPC.
     *
     * IMPORTANT:
     * This page does not independently establish admin authority.
     * MFA verification is delegated to
    ...
    function dependenciesReady() {
        ...
        return Boolean(
            ...
            typeof auth.verifyMfa === "function"
        );
    ...
    /*
     * Supabase returns qr_code as SVG markup.
     * No third-party QR library is required.
     */
    ...
    async function verifyMfa() {
         ...
         * IMPORTANT:
         *
         * Do NOT duplicate challenge/verify/session refresh
         * logic here.
         *
         * The Admin Auth engine is the shared authority for:
         *
         * challenge
         * → verify
         * → refresh session
         * → clear stale context
         * → reload get_my_admin_context()
         */
    ...
    async function init() {
        ...
        try {
            ...
            /*
             * MFA is explicitly not required for this admin.
             * Do not accidentally enroll a new factor.
             */
